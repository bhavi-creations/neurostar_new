  ...
  <div class="container">
    <div class="row align-items-center g-4">
      ...
      <div class="col-12 col-lg-7">
        ...
        <!-- Badge -->
        <div class="index-first-section-badge">
          <i class="fa-solid fa-star"></i> Trusted by 75,000+ Patients <i class="fa-solid fa-chevron-down" style="font-size: 10px;"></i>
        </div>
        ...
        <!-- Buttons Group -->
        <div class="index-first-section-btn-group">
        ...
        <div class="index-first-section-emergency-card">
          <div class="index-first-section-emergency-icon">
      ...
      <!-- Right Stats Stack Column -->
      <div class="col-12 col-lg-5">
        <div class="index-first-section-stats-wrapper">

          <!-- Stat 1: Expert Doctors -->
          <div class="index-first-section-stat-card">
            <div class="index-first-section-stat-icon-box bg-soft-blue">
              <i class="fa-solid fa-user-doctor"></i>
            </div>
            <div>
              <h3 class="index-first-section-stat-number">40+</h3>
              <p class="index-first-section-stat-text">Expert Doctors</p>
            </div>
          </div>

          <!-- Stat 2: Departments -->
          <div class="index-first-section-stat-card">
            <div class="index-first-section-stat-icon-box bg-soft-indigo">
              <i class="fa-solid fa-hospital-user"></i>
            </div>
            <div>
              <h3 class="index-first-section-stat-number">25+</h3>
              <p class="index-first-section-stat-text">Departments</p>
            </div>
          </div>

          <!-- Stat 3: Patient Rating -->
          <div class="index-first-section-stat-card">
            <div class="index-first-section-stat-icon-box bg-soft-amber">
              <i class="fa-solid fa-star"></i>
            </div>
            <div>
              <h3 class="index-first-section-stat-number">4.9/5</h3>
              <p class="index-first-section-stat-text">Patient Rating</p>
            </div>
          </div>

          <!-- Stat 4: Happy Patients -->
          <div class="index-first-section-stat-card">
            <div class="index-first-section-stat-icon-box bg-soft-rose">
              <i class="fa-solid fa-users"></i>
            </div>
            <div>
              <h3 class="index-first-section-stat-number">75,000+</h3>
              <p class="index-first-section-stat-text">Happy Patients</p>
            </div>
          </div>
      ...
      <div class="row g-0 align-items-center">
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <a href="appointment.php" class="service-box">
            ...
            <h6 class="service-title">Book<br>Appointment</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <a href="doctors.php" class="service-box">
            ...
            <h6 class="service-title">Find a<br>Doctor</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <a href="specilities.php" class="service-box">
            ...
            <h6 class="service-title">Our<br>Departments</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
          <a href="#" class="service-box">
            ...
            <h6 class="service-title">Health<br>Checkups</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-3">
          <a href="appointment.php" class="service-box">
            ...
            <h6 class="service-title">Emergency<br>Care</h6>
          </a>
        </div>
...
<!-- ===================================================
         2. THIRD SECTION: Hospital Statistics Banner
         =================================================== -->
...
<!-- ===================================================
         1. FOURTH SECTION: About Us Section
         =================================================== -->
    ...
    <div class="row align-items-center g-4 g-lg-5">
      ...
      <div class="col-lg-6">
        <div class="about-img-wrapper">
          <img src="./assets/img/neurostar-hospital-new.png" alt="Neurostar Hospital Reception">
      ...
      <div class="col-lg-6">
        ...
        <div class="row g-2 mb-3">
          ...
          <div class="col-6">
            <div class="feature-item">
              <i class="fa-solid fa-handshake-angle text-secondary"></i>
              <span>Ethical & Transparent Care</span>
            </div>
          </div>
          <div class="col-6">
            <div class="feature-item">
              <i class="fa-solid fa-house-medical text-danger"></i>
              <span>Affordable & Inclusive</span>
            </div>
          </div>
        </div>

        <!-- Button -->
        <a href="aboutus.php" class="btn-know-more">Know More About Us</a>
      </div>
      ...
      <div class="row g-0">
        ...
        <div class="col-6 col-md-4 col-lg-2">
          <a href="maxillo-facial-surgery.php" class="dept-card">
            ...
            <h6 class="dept-title">Maxillo facial Surgery</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
          <a href="orthopaedic-surgery.php" class="dept-card">
            ...
            <h6 class="dept-title">Orthopedics</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
          <a href="pediatrics.php" class="dept-card">
            ...
            <h6 class="dept-title">Pediatrics</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
          <a href="gynecology.php" class="dept-card">
            ...
            <h6 class="dept-title">Gynecology</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
          <a href="neuro-psychiatric.php" class="dept-card">
            ...
            <h6 class="dept-title">Neuro Psychiatric</h6>
          </a>
        </div>
        ...
        <div class="col-6 col-md-4 col-lg-2">
          <a href="neuro-rehabilitation.php" class="dept-card">
            ...
            <h6 class="dept-title">Neuro rehabilitation</h6>
          </a>
        </div>
...
<!-- ===================================================
         INDEX SIXTH SECTION
         =================================================== -->
<section class="index-sixth-section">
  <div class="container">

    <!-- Section Header Bar -->
    <div class="d-flex justify-content-between align-items-end mb-4">
      <div>
        <span class="section-badge">Featured Treatments</span>
        <h2 class="section-heading">Advanced Treatments for Better Outcomes</h2>
      </div>
      <div>
        <a href="specilities.php" class="view-all-link">
          View All Treatments <i class="fa-solid fa-arrow-right"></i>
        </a>
      </div>
    </div>
    ...
    <!-- <div class="row g-4">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="treatment-card">
            <div class="treatment-img-box">
              <img src="https://images.unsplash.com/photo-1551076805-e1869033e561?q=80&w=600&auto=format&fit=crop" alt="Robotic Surgery">
            </div>
            <div class="treatment-body">
              <h5 class="treatment-title">Robotic Surgery</h5>
              <p class="treatment-desc">Precision. Safety. Faster Recovery.</p>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="treatment-card">
            <div class="treatment-img-box">
              <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?q=80&w=600&auto=format&fit=crop" alt="Joint Replacement">
            </div>
            <div class="treatment-body">
              <h5 class="treatment-title">Joint Replacement</h5>
              <p class="treatment-desc">Advanced care for pain-free movement.</p>
              <a href="#" class="read-more-link">
                Read More <i class="fa-solid fa-arrow-right"></i>
              </a>
            </div>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="treatment-card">
            <div class="treatment-img-box">
              <img src="https://images.unsplash.com/photo-1628348068343-c6a848d2b6dd?q=80&w=600&auto=format&fit=crop" alt="Cardiac Care">
            </div>
            <div class="treatment-body">
              <h5 class="treatment-title">Cardiac Care</h5>
              <p class="treatment-desc">Comprehensive heart care for a healthier life.</p>
              <a href="#" class="read-more-link">
                Read More <i class="fa-solid fa-arrow-right"></i>
              </a>
            </div>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
          <div class="treatment-card">
            <div class="treatment-img-box">
              <img src="https://images.unsplash.com/photo-1559757175-5700dde675bc?q=80&w=600&auto=format&fit=crop" alt="Neuro Care">
            </div>
            <div class="treatment-body">
              <h5 class="treatment-title">Neuro Care</h5>
              <p class="treatment-desc">Expert care for the brain and spine.</p>
              <a href="#" class="read-more-link">
                Read More <i class="fa-solid fa-arrow-right"></i>
              </a>
            </div>
...
<!-- ===================================================
         INDEX EIGHT SECTION
         =================================================== -->
<section class="index-eight-section">
  <div class="container">
